...
public class WebSocketHandshaker {
    ...
    public MessageReader createReader(WebSocketSession session) {
        return new MessageReader(session, extensions);
    }

    public MessageWriter createWriter(WebSocketSession session) {
        return new MessageWriter(session, extensions);
    }
